...
class MatchTimer:  
    def __init__(self, master):  
        ...
        self.create_score_section()  # Tambahkan bagian skor  
        self.create_draw_section()  # Tambahkan bagian draw  
    ...
    def create_score_section(self):  
        ...
        Label(team_a_frame, text="Team A", font=("Helvetica", 24), bg="white").pack(pady=(100, 0))  
        Label(team_a_frame, textvariable=self.team_a_score_str, font=("Helvetica", 48), bg="white").pack()  
        
        Button(team_a_frame, text="WIN (+2)", command=self.increment_team_a_score_by_two, font=("Helvetica", 14)).pack(side="left", pady=10)  
        Button(team_a_frame, text="-", command=self.decrement_team_a_score, font=("Helvetica", 14)).pack(side="left", pady=10)  
        ...
        Label(team_b_frame, text="Team B", font=("Helvetica", 24), bg="white").pack(pady=(100, 0))  
        Label(team_b_frame, textvariable=self.team_b_score_str, font=("Helvetica", 48), bg="white").pack()  
        
        Button(team_b_frame, text="WIN (+2)", command=self.increment_team_b_score_by_two, font=("Helvetica", 14)).pack(side="left", pady=10)  
        Button(team_b_frame, text="-", command=self.decrement_team_b_score, font=("Helvetica", 14)).pack(side="left", pady=10)  

    def create_draw_section(self):  
        # Frame untuk tombol draw dan reset score  
        draw_frame = Frame(self.main_frame, bg="white")  
        draw_frame.pack(pady=10)  

        # Tombol DRAW  
        draw_button = Button(draw_frame,   
                            text="DRAW (+1 for each team)",   
                            command=self.draw_score,   
                            font=("Helvetica", 14),  
                            borderwidth=2,  
                            relief="solid",  
                            width=30,  
                            ...
                            highlightthickness=0)  
        draw_button.pack(pady=(0, 5))  

        # Tombol RESET SCORE  
        reset_score_button = Button(draw_frame,   
                                    text="RESET SCORE",   
                                    ...
                                    activebackground="red",  
                                    highlightthickness=0)  
        reset_score_button.pack()  

    def reset_score(self):  
        # Reset skor kedua tim ke 0  
        self.team_a_score = 0  
        self.team_b_score = 0  
        self.team_a_score_str.set(self.team_a_score)  
        self.team_b_score_str.set(self.team_b_score)  

    def increment_team_a_score_by_two(self):  
        self.team_a_score += 2  
        self.team_a_score_str.set(self.team_a_score)  

    def increment_team_b_score_by_two(self):  
        self.team_b_score += 2  
        self.team_b_score_str.set(self.team_b_score)  
